  ...
  onwrpEventUpdate: function (component, event, helper) {
    ...
    if (sObject == "Account") {
      ...
      component.set(
        ...
        " AND Batch_Code__r.School_Name__c = '" + accountId + "' ORDER BY NAME"
    ...
    if (contactId) {
      ...
      helper.findRecommendationReport(component, event, helper);       
      helper.additionalcacall(component, event, helper);
