({    
    retrieveStudentData : function(component, event, helper) {
        ...
        if(selectedlanguage == 'eng'){
            ...
            component.set("v.studentinfoheader","छात्र जानकारी");
            component.set("v.studentname","छात का पूरा नाम");
            ...
            component.set("v.chooseone","एक का चयन");
            component.set("v.whatsppvalidationmsg","व्हाट्सएप नंबर मान्य नहीं है। यह केवल संख्या प्रारूप में होना चाहिए।");
            component.set("v.contactupdatesuccessmsg","आपकी संपर्कता जानकारी सफलतापूर्वक बदल दिया गया है!");
            ...
            component.set("v.studentinfoheader","विद्यार्थ्यांची माहिती");
            component.set("v.studentname","विद्यार्थ्यांचे पूर्ण नाव");
            ...
            var monthlyIncomeOption = [
                ...
                {value: "I do not know", label: "मला माहित नाहीा"}
            ];
            component.set("v.monthlyIncomeoptions",monthlyIncomeOption);
            ...
            var monthlyIncomeOption = [
                {value: "Below Rs 10,000 per month", label: "10 ہزار روپے ماہانہ سے کم۔"},
                {value: "Rs 10,000-Rs 20,000 per month", label: "10،000 سے 20،000 روپے ماہانہ۔"},
                {value: "More than Rs 20,000 per month", label: "20 ہزار روپے ماہانہ سے زیادہ۔"},
                {value: "I do not know", label: "مجھے معلوم نہیں"}
            ];
            component.set("v.monthlyIncomeoptions",monthlyIncomeOption);
    ...
    handleStartExam : function (component, event, helper) {
		...
		var address = window.location.origin+'/assessment/s/assessmentformclone?contactId='+studentId+'&lang='+language;
