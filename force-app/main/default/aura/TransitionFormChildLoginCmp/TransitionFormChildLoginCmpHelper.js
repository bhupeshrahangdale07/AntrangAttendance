({
    ...
    //CUSTOMCODE : Doing Input Validations
    isInputValid : function (component, event, helper) {
        let isValid = true;
        console.log('Element Name : '+event.currentTarget.required);
        let inputField =event.currentTarget;
            if(!inputField.checkValidity()) {
                inputField.reportValidity();
                isValid = false;
            }
        component.set('v.isValidCmp',isValid);
    }
})