({
	doInit : function(component, event, helper) {
        ...
        //RESOLVE : THIS CODE WAS GETTING US MAXIMUM CALL STACK ERROR (MAIN ERROR).
        //CUSTOMCODE : to convert the value to Numeric
        // if (component.get("v.fieldType")=='Numeric') {
        //     let userEnteredValue = component.get('v.userEnteredAnswervalue');
        //     component.set('v.userEnteredAnswervalue',parseInt(userEnteredValue));
        // }
        //TILL HERE
	},
