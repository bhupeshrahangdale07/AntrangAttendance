({
    ...
    setPickListName : function(component, selectedOptions) {
            ...
            if(selectedOptions.length < 1){
                ...
                component.set("v.selectedLabel", selections.slice(0, -1));
                    ...
                    this.onOptionClick(component, option);
                });
                }
    ...
    onOptionClick: function(component, ddOption) {
            ...
            var clickedValue = {"value":ddOption.closest("li").getAttribute('data-id'),
                                "label":ddOption.closest("li").getAttribute('data-name')};
        ...
        var mainOptions = component.get("v.msoptions");  
