({
	retrieveStudentData : function(component, event, helper) {
        ...
        if(selectedlanguage == 'hin'){
            ...
            component.set("v.CareerPlanningHeader","भविष्य की योजना");
            ...
            component.set("v.submitbtn","दर्ज करें");
            component.set("v.careerheader","आजीविका");
            component.set("v.qualificationheader","योग्यता");
        }
        else if(selectedlanguage == 'mar'){
            component.set("v.SelfAwarenessHeader","स्व जागृतीा");
            component.set("v.CareerAwarenessHeader","करियर जागरूकता");
            component.set("v.ParentSupportHeader","पालक आधार");
            component.set("v.CareerPlanningHeader","करिअर नियोजना");
