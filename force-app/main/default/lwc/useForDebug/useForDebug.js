...
import getApexRecord from '@salesforce/apex/useForDebug.getApexRecord';
import saveQuestion11 from '@salesforce/apex/useForDebug.saveQuestion11';
import saveQuestion15 from '@salesforce/apex/useForDebug.saveQuestion15';
import saveSingle from '@salesforce/apex/useForDebug.saveSingle';
import saveQuestion12 from '@salesforce/apex/useForDebug.saveQuestion12';
import saveAllQA from '@salesforce/apex/useForDebug.saveAllQA';
import submitAndCalculate from '@salesforce/apex/useForDebug.submitAndCalculate';

export default class UseForDebug extends NavigationMixin(LightningElement) {
    //=======================================================//
    fem = null;
    sch = null;
    grd = null;
    ...
    //=======================================================//
    question12 = '12. Which 2 sentences best describe good teamwork? (Tick ONLY 2 options)';
    initAnswer12 = [];
    ...
    @track q15_01_Options = [
        {
            optionName:'1', 
            answer: false,
            optionValue:'(1) I do not know'          
        },
        {
            optionName:'2',
            answer: false,
            optionValue:'(2) Not good at all'
        },
        {
            optionName:'3',
            answer: false,
        ...
        },
        {
            optionName:'4',
            answer: false,
            optionValue:'(4) Very good' 
        },
		{
            optionName:'5',
            answer: false,
            optionValue:'(5) Excellent' 
        },
        {
            optionName:'*',
            answer: false,
    ...
    fpNavigateToInternalPage() {
        ...
        this[NavigationMixin.Navigate]({
            ...
            attributes: {
                name: 'Endline_Future_Planning__c'
            },
            state: {
    ...
    cpNavigateToInternalPage() {
        ...
        this[NavigationMixin.Navigate]({
            type: 'comm__namedPage',
            attributes: {
                name: 'Career_Planning_A_Endline__c'
            },
            state: {
                fem : encodeURI(this.fem),
                sch : encodeURI(this.sch),
