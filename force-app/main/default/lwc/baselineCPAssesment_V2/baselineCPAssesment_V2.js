...
export default class BaselineCPAssesment_V2 extends NavigationMixin(LightningElement){
    ...
    getStudentRecords(){
        ...
        .then(result => {
            ...
            let rxError;
            if(this.isEnglish){
                this.errorTitle = 'Baseline Career Planning Assessment';
                this.rxError = 'Error while receiving student records';
            }else{
                this.errorTitle = 'बेसलाइन भविष्य की योजना मूल्यांकन';
