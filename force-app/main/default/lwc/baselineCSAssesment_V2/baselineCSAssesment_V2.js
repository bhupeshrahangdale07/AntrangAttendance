...
export default class BaselineCSAssesment_V2 extends NavigationMixin(LightningElement){
    ...
    getStudentRecords(){
        ...
        .then(result => {
            ...
            let rxError;
            if(this.isEnglish){
                this.errorTitle = 'Baseline Career Skills Assessment';
                this.rxError = 'Error while receiving student records';
            }else{
                this.errorTitle = 'बेसलाइन कैरियर कौशल मूल्यांकन';
            ...
            if(result === 'found'){
                ...
                if(this.batchId && this.grade){
                    let pageReference = {
                        ...
                        attributes: {
                            name: 'Career_Skills_Baseline_V2__c'
                        }, 
                        state:{
