...
export default class CareerDecisionMaking_01_Endline_V2 extends NavigationMixin(LightningElement) {
    lng;
    isEnglish;
    typ;
    title = '';
    ...
    getCurrentPageReference(currentPageReference) {
        if(currentPageReference) 
        {
            ...
            if(this.isEnglish){
                this.title = 'Endline Career Decision Making-1 Data';
                this.errorTitle = 'Error';
                this.successMsg ='Endline Career Decision Making-1 - Student data has been saved';
                this.successTitle = 'Success'
            }else{
                this.title = 'एंडलाइन करियर के निर्णय-1 डेटा';
            ...
            {*/
                ...
                do{
                    ...
                    .then(result => {
                        ...
                        let errorTitle;
                        if(this.isEnglish){
                            errorTitle = 'Endline Career Decision Making-1';
                            rxError = 'Error while receiving student records';
                        }else{
                            errorTitle = 'एंडलाइन करियर के निर्णय - 1';
