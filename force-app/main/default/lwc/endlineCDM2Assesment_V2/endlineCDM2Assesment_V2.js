...
export default class EndlineCDM2Assesment_V2 extends NavigationMixin(LightningElement) {
    ...
    addAssementHandler(event){
        ...
        var studentId = encodeURI(event.target.value);
            ...
            .then(result => {
                ...
                let errorTitle;
                if(this.isEnglish){
                    errorTitle = 'Endline CDM2 Assessment';
                    rxError = 'Error while receiving student records';
                }else{
                    errorTitle = 'एंडलाइन सीडीएम2 मूल्यांकन';
