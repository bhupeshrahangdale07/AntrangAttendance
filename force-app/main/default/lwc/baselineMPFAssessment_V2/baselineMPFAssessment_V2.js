...
export default class BaselineMPFAssessment_V2 extends NavigationMixin(LightningElement) {
    ...
    getStudentRecords(){
        ...
        .then(result => {
            ...
            let rxError;
            if(this.isEnglish){
                this.errorTitle = 'Baseline Feedback Assessment';
                this.rxError = 'Error while receiving student records';
            }else{
                this.errorTitle = 'बेसलाइन कार्यक्रम प्रतिक्रिया मूल्यांकन';
    ...
    addAssementHandler(event){
        ...
        if(this.batchId && this.grade){
            let pageReference = {
                ...
                attributes: {
                    name: 'baseline_feedback_form_V2__c'
                }, 
                state:{
