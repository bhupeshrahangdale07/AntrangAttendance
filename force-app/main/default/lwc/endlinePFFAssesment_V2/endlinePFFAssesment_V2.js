...
export default class EndlinePFFAssesment_V2 extends NavigationMixin(LightningElement) {
    ...
    addAssementHandler(event){
        ...
        if(this.batchId && this.grade){
            ...
            .then(result => {
                ...
                let errorTitle;
                if(this.isEnglish){
                    errorTitle = 'Endline Planning For Future Assessment';
                    rxError = 'Error while receiving student records';
                }else{
                    errorTitle = 'एंडलाइन भविष्य के लिए योजना मूल्यांकन';
