...
import SaveAllData from '@salesforce/apex/EndlineFeedbackController.SaveAllData';
import calculateForms from '@salesforce/apex/EndlineFuturePlanningController.calculateForms';
import getStudentRecord from '@salesforce/apex/EndlineFeedbackController.getStudentRecord';
import getAssesmentQuestion from '@salesforce/apex/AssesementQuestionController.getAssesmentQuestion';
import getStudentName from '@salesforce/apex/EndlineFeedbackController.getStudentName';
import getEndlineRecord from '@salesforce/apex/EndlineAssessmentController.getEndlineRecord';

export default class FeedbackEndlineV2 extends NavigationMixin(LightningElement) {
    ...
    getStateParameters(currentPageReference) {
       if (currentPageReference) {
          ...
          if(currentPageReference.state.studentName !== undefined)this.studentName = decodeURI(currentPageReference.state.studentName);
          ...
          if(this.selectedBatchId){
            ...
            if(this.isEnglish){
                this.title = 'Endline Feedback Data';
                this.errorTitle = 'Error';
                this.successMsg ='Endline Feedback - Student data has been saved';
                this.successTitle = 'Success'
            }else{
                this.title = 'एंडलाइन कार्यक्रम प्रतिक्रिया डेटा';
    ...
    SubmitBtnHandler(){
        debugger;
        console.log('this.queF1Value =',this.queF1Value)
            ...
            //await this.SaveData();
             getEndlineRecord({
                    ...
                    .then(result => {
                        ...
                        let errorTitle;
                        if(this.isEnglish){
                            errorTitle = 'Endline Feedback';
                            rxError = 'Error while receiving student records';
                        }else{
                            errorTitle = 'एंडलाइन प्रतिपुष्टि';
