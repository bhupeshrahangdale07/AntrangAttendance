...
export default class Quiz1Grade9 extends NavigationMixin(LightningElement) {
    //=======================================================//
    submitStatus = false;
    batchNumber='';
    //=======================================================//
    ...
    //=======================================================//
    question02 = '2. Raj\'s interest code is Enterprising (likes to lead people/be a leader). Which set of careers best match his interest?  (Remember, all careers in the set should match)';
    initAnswer02 = '';
    @track q02_Options = [
        {
            optionName:'A', 
            answer: false,
            optionValue:'(a) Lawyer, Business Owner, Politician'          
        },
        {
            optionName:'B',
            answer: false,
            optionValue:'(b) Writer, Receptionist, Business Owner'
        },
        {
            optionName:'C',
            answer: false,
            optionValue:'(c) Engineer, Actor, Plumber'
        },
        {
            optionName:'D',
            answer: false,
            optionValue:'(d) Nurse, Sportsperson, Teacher' 
        },
        {
            optionName:'*',
            answer: false,
    ...
    //=======================================================//
    question03 = '3. Reshma is good at finding patterns and connections between things (Abstract Aptitude)Which set of careers best match her aptitude? (Remember, all careers in the set should match.)';
    initAnswer03 = '';
    @track q03_Options = [
        {
            optionName:'A', 
            answer: false,
            optionValue:'(a) Banker, Accountant, Teacher'          
        },
        {
            optionName:'B',
            answer: false,
            optionValue:'(b) Salesperson, Beautician, Nurse'
        },
        {
            optionName:'C',
            answer: false,
            optionValue:'(c) Police Officer, Scientist, Doctor'
        },
        {
            optionName:'D',
            answer: false,
            optionValue:'(d) Actor, School Administrator, Business Owner' 
        },
        {
            optionName:'*',
            answer: false,
    ...
    //=======================================================//
    question04 = '4. When choosing a career, the most important thing to keep in mind is';
    initAnswer04 = '';
    @track q04_Options = [
        {
            optionName:'A', 
            answer: false,
            optionValue:'(a) Starting salary and the parent\'s choice'          
        },
        {
            optionName:'B',
            answer: false,
            optionValue:'(b) Things someone is good at and likes doing'
        },
        {
            optionName:'C',
            answer: false,
            optionValue:'(c) Things someone is good at and starting salary'
        },
        {
            optionName:'D',
            answer: false,
            optionValue:'(d) Things someone likes doing and parent\'s choice' 
        },
        {
            optionName:'*',
            answer: false,
    ...
    //=======================================================//
    question05 = '5. Which of these is correct?';
    initAnswer05 = '';
    @track q05_Options = [
        {
            optionName:'A', 
        ...
        },
        {
            optionName:'D',
            answer: false,
            optionValue:'(d) Vocational Certificate Courses are available for all careers' 
        },
        {
            optionName:'*',
            answer: false,
    ...
    getApexRecordSAF(){
        ...
        getApexRecord({
            ...
            this.isLoading = false;
            let rxError = 'Error while recieving record fields: Quiz1-Grade 9';
