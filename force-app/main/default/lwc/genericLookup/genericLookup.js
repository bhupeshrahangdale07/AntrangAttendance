...
import fetchLookupData from '@salesforce/apex/GenericLookupController.fetchLookupData';
const DELAY = 300;
...
export default class Customlookup extends LightningElement {
    ...
    @api defaultRecordId = '';
    @api whereclause = '';
    @api fieldNameForLabel = '';
    @api fieldNameForValue = '';
    @api queryfields = '';
    @api querygroupby = '';
    @api selectedDistricts = '';
    ...
    @wire(fetchLookupData, {
        searchKey: '$searchKey', sObjectApiName: '$sObjectApiName', whereclause: '$whereclause',
        fieldNameForLabel: '$fieldNameForLabel', fieldNameForValue: '$fieldNameForValue',
        querygroupby: '$querygroupby', queryfields: '$queryfields', selectedDistricts: '$selectedDistricts'
    })
    searchResult(value) {
        //debugger;
