...
import getRecordCDM2 from '@salesforce/apex/careerDecisionMaking_02_Endline.getRecordCDM2';
import saveQuestion05 from '@salesforce/apex/careerDecisionMaking_02_Endline.saveQuestion05';
import saveQuestion06 from '@salesforce/apex/careerDecisionMaking_02_Endline.saveQuestion06';
import saveAllQA from '@salesforce/apex/careerDecisionMaking_02_Endline.saveAllQA';
import submitAndCalculate from '@salesforce/apex/careerDecisionMaking_02_Endline.submitAndCalculate';
...
export default class CareerDecisionMaking_02_Endline_V2 extends NavigationMixin(LightningElement) {
    lng;
    isEnglish;
    title = '';
    errorTitle = '';
    ...
    delayTimeOut12;
    //=======================================================//
    question05 = ''; //'5. I feel confident about my chosen career because (Tick ONLY 1 option)';
    initAnswer05 = '';
    @track q05_Options = [];
    ...
    getCurrentPageReference(currentPageReference) {
        if(currentPageReference) 
        {
            ...
            if(this.isEnglish){
                this.title = 'Endline Career Decision Making-2 Data';
                this.errorTitle = 'Error';
                this.successMsg ='Endline Career Decision Making-2 - Student data has been saved';
                this.successTitle = 'Success'
            }else{
                this.title = 'एंडलाइन करियर के निर्णय-2 डेटा';
            ...
            {*/
                do{
                    ...
                    .then(result => {
                        ...
                        let errorTitle;
                        if(this.isEnglish){
                            errorTitle = 'Endline Career Decision Making-2';
                            rxError = 'Error while receiving student records';
                        }else{
                            errorTitle = 'एंडलाइन करियर के निर्णय - 2';
    ...
    cpNavigateToInternalPage() {
        ...
        this[NavigationMixin.Navigate]({
            ...
            state: {
                ...
                studentName : encodeURI(this.studentName),
                cdm1Id : encodeURI(this.cdm1Id),
                cdm2Id : encodeURI(this.rxRecordIdCMD2),
                typ : this.typ,
                lng : this.lng
            }
        });
