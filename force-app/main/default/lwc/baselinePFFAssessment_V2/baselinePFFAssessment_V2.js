...
export default class BaselinePFFAssessment_V2 extends NavigationMixin(LightningElement) {
    ...
    getStudentRecords(){
        ...
        .then(result => {
            ...
            let rxError;
            if(this.isEnglish){
                this.errorTitle = 'Baseline Planning For Future Assessment';
                this.rxError = 'Error while receiving student records';
            }else{
                this.errorTitle = 'बेसलाइन भविष्य का नियोजन मूल्यांकन';
    ...
    addAssementHandler(event){
        ...
        if(this.batchId && this.grade){
            let pageReference = {
                ...
                attributes: {
                    name: 'Future_Planning_Baseline_V2__c'
                }, 
                state:{
